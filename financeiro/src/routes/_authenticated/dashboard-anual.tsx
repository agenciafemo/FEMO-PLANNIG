...
export const Route = createFileRoute("/_authenticated/dashboard-anual")({
  head: () => ({ meta: [{ title: "Dashboard Anual — FEMO FINANÇAS" }] }),
  component: () => (
    <Suspense fallback={<PageContainer><div className="text-muted-foreground text-sm">Carregando…</div></PageContainer>}>
      <DashboardAnual />
    </Suspense>
  ),
});
