...
/**
 * As marcas dos canais, num lugar só.
 *
 * Viviam espalhadas: a da Meta dentro de Relatorios.tsx, a do Google Ads dentro
 * do componente de indicadores. Duas telas desenhando a mesma marca por conta
 * própria é como se chega em dois Google Ads diferentes na mesma página.
 */
...
export function GoogleAdsIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="currentColor" aria-hidden="true">
      <path d="M10 3a4 4 0 0 1 7 0l6 11a4 4 0 0 1-7 4L10 7a4 4 0 0 1 0-4Z" />
      <path opacity=".65" d="m9 6 4 7-4 7a4 4 0 1 1-7-4Z" />
      <circle cx="5.5" cy="18" r="4" />
    </svg>
  );
}
